...
namespace inhifistereo.httptrigger1
{
    public static class CreateProduct
    {
            ...
            ILogger log)
        {
            ...
            document = new { productDescription = "This starfruit ice cream is out of this world!", productId = Guid.NewGuid(), productName = "Starfruit Explosion", timestamp = DateTime.Now };
